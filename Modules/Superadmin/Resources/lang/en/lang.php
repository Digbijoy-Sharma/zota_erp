...
return [
    ...
    // Auto-PO settings (per-store + chain-wide)
    'auto_po_frequency' => 'Auto Purchase Order Frequency',
    'auto_po_frequency_days' => 'Auto-PO every (days)',
    'auto_po_frequency_help' => 'How often (1–30 days) an automatic Purchase Order is raised for this store, combining all products that have hit their minimum stock. Leave blank to inherit the chain-wide default.',
    'auto_po_frequency_inherited' => 'Currently inheriting the chain-wide default of :days day(s).',
    'auto_po_frequency_off' => 'No frequency set here or chain-wide — auto-PO is currently OFF for this store.',
    'auto_po_frequency_updated' => 'Auto-PO frequency updated for :business',
    'auto_po_frequency_updated_all' => 'Auto-PO frequency applied to all stores',
    'apply_po_freq_chain_wide' => 'Apply this frequency to ALL stores',
    'inherit' => 'Inherit',
    'auto_po_goes_to' => 'Auto-POs go to',
    'auto_po_supplier_none_assigned' => 'No supplier is assigned to this store yet — auto-POs cannot be raised. Assign one first:',

    // Supplier (warehouse) portal logins
    'supplier_logins' => 'Supplier Logins',
    'supplier_logins_help' => 'Create and manage warehouse/supplier portal logins',
    'create_supplier_login' => 'Create Supplier Login',
    'existing_supplier_logins' => 'Existing Supplier Logins',
    'all_suppliers_have_logins' => 'All suppliers already have a portal login.',
    'no_supplier_logins' => 'No supplier logins created yet.',
    'active' => 'Active',
    'disabled' => 'Disabled',
    'enable' => 'Enable',
    'disable' => 'Disable',
    'reset_password' => 'Reset password',
    'supplier_login_exists' => 'This supplier already has a portal login.',
    'supplier_login_created' => 'Portal login created for :supplier.',
    'supplier_login_enabled' => 'Supplier login enabled.',
    'supplier_login_disabled' => 'Supplier login disabled.',
    'supplier_login_password_reset' => 'Supplier login password reset.',
];