          ...
          <div class="row check_group">
            ...
            <div class="col-md-9">
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'supplier_portal.view_dashboard', false, [ 'class' => 'input-icheck']); !!} @lang( 'lang_v1.supplier_portal_view_dashboard' )
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'supplier_portal.view_po', false, [ 'class' => 'input-icheck']); !!} @lang( 'lang_v1.supplier_portal_view_po' )
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'supplier_portal.update_po_status', false, [ 'class' => 'input-icheck']); !!} @lang( 'lang_v1.supplier_portal_update_po_status' )
                  </label>
                </div>
              </div>
            </div>
