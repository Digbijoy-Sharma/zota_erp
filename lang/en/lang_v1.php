...
return [
    ...
    'enable_damage_loss_tracking' => 'Enable Damage/Loss Tracking',
    'tooltip_enable_damage_loss_tracking' => 'This will enable you to record damaged or lost quantity for each GRN line item, in addition to the good quantity entered in Purchase Quantity. Damaged/lost quantity is never added to sellable stock.',
    ...
    'default_sell_sub_unit' => 'Default Sale Unit',
    'default_sell_sub_unit_help' => 'The unit pre-selected for this product at the POS. E.g. "Strip" when a medicine is mostly sold in strips but can also be sold loose in tablets. Must be one of the Related Sub Units or the Base Unit.',
    'default_purchase_sub_unit' => 'Default Purchase Unit',
    'default_purchase_sub_unit_help' => 'The unit pre-selected for this product at purchase entry. E.g. "Baby Box" when the supplier always delivers in baby boxes. Must be one of the Related Sub Units or the Base Unit.',
    'sell_sub_units' => 'Sellable Units',
    'sell_sub_units_help' => 'Units this product may be SOLD in at the POS. E.g. select only "Tablet" and "Strip" so a medicine can never be sold as a whole Baby Box. Leave blank to allow all Related Sub Units.',
    'purchase_sub_units' => 'Purchasable Units',
    'purchase_sub_units_help' => 'Units this product may be PURCHASED in. E.g. select only "Baby Box" so purchase orders and purchases are always entered in boxes. Leave blank to allow all Related Sub Units.',
    'unit_not_allowed_for_selling' => 'Unit ":unit" is not allowed for selling ":product". Please choose one of the allowed sale units.',
    'unit_not_allowed_for_purchasing' => 'Unit ":unit" is not allowed for purchasing ":product". Please choose one of the allowed purchase units.',
    'enable_sub_units' => 'Enable Sub Units',
    'import_opening_stock_sub_unit_help' => 'Optional. If set, the quantity and unit cost are interpreted in this sub-unit (e.g. "Baby Box") and converted to the product\'s base unit before saving. Leave blank for base units. Must match an existing unit name (or actual_name/short_name) in this business.',
    'sub_unit' => 'Sub Unit',
    'added_on' => 'Added On',
    ...
    'purchase_imported_successfully' => 'Purchases imported successfully',
    'import_purchase_product_not_found' => 'Product with name :product_name or sku :sku not found in row :row',
    'import_purchase_tax_not_found' => 'Tax with name :tax_name not found in row :row',
    'invalid_purchase_status_at' => 'Invalid status :status at row :row',
    'supplier_name_cannot_be_empty_in_row' => 'Supplier name is required in row :row',
    'unit_cost_cannot_be_empty_in_row' => 'Unit cost before discount is required in row :row',
    'supplier_phone_number' => 'Supplier Phone Number',
    'tax_name' => 'Tax Name',
    'supplier_email' => 'Supplier Email',
    'ref_numbers' => 'Reference Numbers',
    'import_purchase_all_or_nothing_note' => 'If any row references a product/SKU that does not exist, the entire import is cancelled and no purchases are created, even for the other rows.',
    'import_purchase_invalid_template' => 'The uploaded file\'s columns do not match the required template. Please use the provided template as-is, without renaming, reordering, adding, or removing columns.',
    'ref_no_cannot_be_empty_in_row' => 'Reference No is required in row :row',
    'ref_no_groups_purchase_lines_instruction' => 'Required. Rows sharing the same Reference No are combined into one purchase.',
    'do_not_modify_template_columns' => 'Download the template and fill it in without renaming, reordering, adding, or removing any columns.',
    'choose_purchase_location' => 'Choose the business location the purchases will be added to',
    'purchase_import_unit' => 'Unit',
    'import_purchase_unit_instruction' => 'Optional. Leave blank to use the product\'s default purchase unit. If that product restricts which units it can be purchased in ("Purchase Sub Units" on the product\'s edit page) and its default unit is not on that list, you must enter an allowed unit here instead, or the import will fail. Quantity and cost columns are read in terms of whichever unit is entered here.',
    'import_purchase_unit_not_found' => 'Unit with name :unit_name not found in row :row',
    'import_purchase_unit_restriction_note' => 'Some products only allow purchasing in specific units (see "Purchase Sub Units" on that product\'s edit page). If a row leaves the Unit column blank for such a product, the import fails with an error naming the unit that was rejected — check the product\'s allowed purchase units and enter one of them in the Unit column.',
    'import_revert_blocked' => 'Cannot revert this batch: purchase :ref_no could not be deleted (:reason). No purchases in this batch were reverted — resolve that first (e.g. delete/edit the linked return), then try again.',
    'import_purchase_orders' => 'Import Purchase Orders',
    'preview_imported_purchase_orders' => 'Preview Imported Purchase Orders',
    'purchase_order_imported_successfully' => 'Purchase orders imported successfully',
    'import_purchase_order_product_not_found' => 'Product with name :product_name or sku :sku not found in row :row',
    'import_purchase_order_tax_not_found' => 'Tax with name :tax_name not found in row :row',
    'invalid_purchase_order_status_at' => 'Invalid status :status at row :row',
    'import_purchase_order_all_or_nothing_note' => 'If any row references a product/SKU that does not exist, the entire import is cancelled and no purchase orders are created, even for the other rows.',
    'import_purchase_order_invalid_template' => 'The uploaded file\'s columns do not match the required template. Please use the provided template as-is, without renaming, reordering, adding, or removing columns.',
    'ref_no_groups_po_lines_instruction' => 'Required. Rows sharing the same Reference No are combined into one purchase order.',
    'choose_purchase_order_location' => 'Choose the business location the purchase orders will be added to',
    'import_revert_po_blocked' => 'Cannot revert this batch: purchase order :ref_no could not be deleted (:reason). No purchase orders in this batch were reverted — resolve that first, then try again.',
    ...
    'below_25c' => 'Store Below 25°C',
    'refrigerate_2_8c' => 'Refrigerate (2-8°C)',
    ...
    'super_fast_moving' => 'Super Fast Moving (SFM)',
    'fast_moving' => 'Fast Moving (FM)',
    'normal_fast_moving' => 'Normal Fast Moving (NFM)',
    'slow_moving' => 'Slow Moving (SM)',
    'last_updated' => 'Last Updated',
    'next_update' => 'Next Update',
    'pharmacy_details' => 'Pharmacy Details',
    'manufacturer_added_success' => 'Manufacturer added successfully',
    'manufacturer_updated_success' => 'Manufacturer updated successfully',
    'manufacturer_deleted_success' => 'Manufacturer deleted successfully',
    'division_added_success' => 'Division added successfully',
    'division_updated_success' => 'Division updated successfully',
    'division_deleted_success' => 'Division deleted successfully',

    'import_stock_settings' => 'Import Stock Settings',
    'import_stock_settings_help' => 'Bulk update Min/Max Qty & Movement Tags per store',
    'step_1_download_csv' => 'Step 1: Download CSV for a Store',
    'step_2_upload_csv' => 'Step 2: Upload Updated CSV',
    'select_store' => 'Select Store',
    'please_select' => 'Please Select',
    'please_select_store' => 'Please select a store',
    'no_location_found_for_store' => 'No location found for the selected store',
    'download_csv' => 'Download CSV',
    'import_settings' => 'Import Settings',
    'download_csv_instruction' => 'Select a store and download the CSV. It will contain all products with their current Min Qty, Max Qty and Movement Tag for that store. Update the values and upload it back.',
    'please_select_file' => 'Please select a file to upload',
    'no_data_found_in_file' => 'No data found in the uploaded file',
    'stock_settings_import_success' => ':updated rows updated successfully, :skipped rows skipped',
    'errors' => 'Errors',
    'and_more' => ':count more errors...',
    'row_no' => 'Row',
    'variation_id_missing' => 'Variation ID is missing',
    'variation_not_found' => 'Variation with SKU :sku not found or does not belong to this business',
    'invalid_min_qty' => 'Min Qty must be a number >= 0',
    'invalid_max_qty' => 'Max Qty must be a number >= 0',
    'invalid_movement_tag' => 'Invalid movement tag ":tag". Allowed: SFM, FM, NFM, SM',
    'read_only' => 'Read Only',
    'min_quantity' => 'Min Qty',
    'max_quantity' => 'Max Qty',
    'stock_settings_instruction_line1' => 'Follow the instructions below to import stock settings:',
    'stock_settings_instruction_line2' => 'First download the CSV for the store you want to update. The CSV will have all products pre-loaded. Update the Min Qty, Max Qty, and Movement Tag columns, then upload the file back for the same store.',
    'variation_id_ins' => 'Auto-generated ID. Do not modify this column — it is used to match products during import.',
    'sku_ref_ins' => 'Product SKU for reference. Do not modify.',
    'product_name_ref_ins' => 'Product name for reference. Do not modify.',
    'variation_ref_ins' => 'Variation name for reference (shows "-" for single products). Do not modify.',
    'min_qty_ins' => 'Minimum stock quantity for this product at the selected store. Enter a number >= 0 or leave blank for 0.',
    'max_qty_ins' => 'Maximum stock quantity for this product at the selected store. Enter a number >= 0 or leave blank for 0.',
    'movement_tag_ins' => 'Movement classification tag. Leave blank to clear. Must be one of the allowed options.',
];